...
public class MainSwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener {
    ...
    public MainSwitchBar(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mBackgroundOn = AppCompatResources.getDrawable(context, R.drawable.settingslib_switch_bar_bg_on);
        mBackgroundOff = AppCompatResources.getDrawable(context, R.drawable.settingslib_switch_bar_bg_off);
        mBackgroundDisabled = AppCompatResources.getDrawable(context,
